...
class Downloader:
    ...
    def run(self):
        ...
        while True:
            ...
            self.step = "Step " + str(self.set_step) + " of 6"
                ...
                if os.path.exists("TFTCversion.txt"):
                    with open(r'TFTCversion.txt', 'r') as file:
                        ...
                        if not '1.3.2' in content:
                            print('string exist')
                            self.set_message("Please complete the TFTC 1.3.2 Patch executable install process and press OK when installation is complete.")
